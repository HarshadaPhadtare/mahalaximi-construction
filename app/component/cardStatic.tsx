...
export const constructionCards = [
  { img: "/plotarea.jpg", title: "Modern Infrastructure", desc: "Building strong foundations with advanced engineering." },
  { img: "/plotarea.jpg", title: "Smart Construction", desc: "Innovative technologies for sustainable growth." },
  { img: "/plotarea.jpg", title: "Project Management", desc: "Delivering projects on time with quality assurance." },
  { img: "/plotarea.jpg", title: "Industrial Projects", desc: "Large-scale constructions with modern techniques." },
];
