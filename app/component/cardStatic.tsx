...
export const constructionCards = [
  { img: "/home1.jpg", title: "Modern Infrastructure", desc: "Building strong foundations with advanced engineering." },
  { img: "/home2.jpg", title: "Smart Construction", desc: "Innovative technologies for sustainable growth." },
  { img: "/building1.jpg", title: "Project Management", desc: "Delivering projects on time with quality assurance." },
  { img: "/building2.jpg", title: "Industrial Projects", desc: "Large-scale constructions with modern techniques." },
];
...
export const realEstateCards = [
  ...
  { img: "/plot1.jpg", title: "Commercial Spaces", desc: "Perfect locations for your business growth." },
